...
CORS(app, origins=[
    ...
    "http://localhost:1421",    # Kodama Tauri dev server
...
def get_playlist(playlist_id):
    try:
        ...
        # Auto-generated radio / mix playlists (Supermix, Archive Mix, RD…).
        # get_playlist(limit=None) paginates forever on these — use watch playlist.
        if playlist_id.startswith("RD"):
            return get_radio(playlist_id)
